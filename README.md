...
| [axanta-erp](skills/axanta-erp/) | When the user wants to check product stock levels, inventory quantities, or availability across stores using Axanta... |
| [churn-prevention](skills/churn-prevention/) | When the user wants to reduce churn, build cancellation flows, set up save offers, recover failed payments, or... |
| [claude-ads](skills/claude-ads/) | When the user wants AI-automated ad operations — campaign audits, cross-platform budget optimization, automated... |
...
| [sales-automation-selection](skills/sales-automation-selection/) | When the user needs to choose, compare, or roll out automation for a sales operation — CRM, workflow tools, RPA, or AI... |
...
| [sales-process-audit](skills/sales-process-audit/) | When the user wants to find out where a sales process is leaking revenue and what to fix first. Use when the user... |
